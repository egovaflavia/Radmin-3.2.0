        ...
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                <div class="nav-item {{ ($segment1 == 'dashboard') ? 'active' : '' }}">
                    <a href="{{route('dashboard')}}"><i class="ik ik-bar-chart-2"></i><span>{{
                            __('Dashboard')}}</span></a>
                </div>
                ...
                <div
                    ...
                    <div class="submenu-content">
                        ...
                        <a href="{{url('user/create')}}"
                            class="menu-item {{ ($segment1 == 'user' && $segment2 == 'create') ? 'active' : '' }}">{{
                            __('Add User')}}</a>
                        @endcan
                        ...
                        <a href="{{url('permission')}}"
                            class="menu-item {{ ($segment1 == 'permission') ? 'active' : '' }}">{{
                            __('Permission')}}</a>
                        @endcan
                    </div>
                </div>
                ...
                <div class="nav-item {{ ($segment1 == 'permission-example') ? 'active' : '' }}">
                    <a href="{{url('permission-example')}}"><i class="ik ik-unlock"></i><span>{{ __('Laravel
                            Permission')}}</span> </a>
                </div>
                <div class="nav-item {{ ($segment1 == 'table-datatable-edit') ? 'active' : '' }}">
                    <a href="{{url('table-datatable-edit')}}"><i class="ik ik-layout"></i><span>{{ __('Editable
                            Datatable')}}</span> </a>
                ...
                <div
                    ...
                    <div class="submenu-content">
                        <a href="{{url('form-components')}}"
                            class="menu-item {{ ($segment1 == 'form-components') ? 'active' : '' }}">{{
                            __('Components')}}</a>
                ...
                <div class="nav-item {{ ($segment1 == 'table-bootstrap') ? 'active' : '' }}">
                    <a href="{{url('table-bootstrap')}}"><i class="ik ik-credit-card"></i><span>{{ __('Bootstrap
                            Table')}}</span></a>
                </div>
                <div class="nav-item {{ ($segment1 == 'table-datatable') ? 'active' : '' }}">
                    <a href="{{url('table-datatable')}}"><i class="ik ik-inbox"></i><span>{{ __('Data
                            Table')}}</span></a>
                </div>
                ...
                <div
                    ...
                    <div class="submenu-content">
                        <a href="{{url('widgets')}}" class="menu-item {{ ($segment1 == 'widgets') ? 'active' : '' }}">{{
                            __('Basic')}}</a>
                        <a href="{{url('widget-statistic')}}"
                            class="menu-item {{ ($segment1 == 'widget-statistic') ? 'active' : '' }}">{{
                            __('Statistic')}}</a>
                        <a href="{{url('widget-data')}}"
                            class="menu-item {{ ($segment1 == 'widget-data') ? 'active' : '' }}">{{ __('Data')}}</a>
                        <a href="{{url('widget-chart')}}"
                            class="menu-item {{ ($segment1 == 'widget-chart') ? 'active' : '' }}">{{ __('Chart
                            Widget')}}</a>
                    </div>
                </div>
                <div
                    ...
                    <div class="submenu-content">
                        <a href="{{url('alerts')}}" class="menu-item {{ ($segment1 == 'alerts') ? 'active' : '' }}">{{
                            __('Alerts')}}</a>
                        <a href="{{url('badges')}}" class="menu-item {{ ($segment1 == 'badges') ? 'active' : '' }}">{{
                            __('Badges')}}</a>
                        <a href="{{url('buttons')}}" class="menu-item {{ ($segment1 == 'buttons') ? 'active' : '' }}">{{
                            __('Buttons')}}</a>
                        <a href="{{url('navigation')}}"
                            class="menu-item {{ ($segment1 == 'navigation') ? 'active' : '' }}">{{
                            __('Navigation')}}</a>
                    </div>
                </div>
                <div
                    ...
                    <div class="submenu-content">
                        <a href="{{url('modals')}}" class="menu-item {{ ($segment1 == 'modals') ? 'active' : '' }}">{{
                            __('Modals')}}</a>
                        <a href="{{url('notifications')}}"
                            class="menu-item {{ ($segment1 == 'notifications') ? 'active' : '' }}">{{
                            __('Notifications')}}</a>
                        <a href="{{url('carousel')}}"
                            class="menu-item {{ ($segment1 == 'carousel') ? 'active' : '' }}">{{ __('Slider')}}</a>
                        <a href="{{url('range-slider')}}"
                            class="menu-item {{ ($segment1 == 'range-slider') ? 'active' : '' }}">{{ __('Range
                            Slider')}}</a>
                        <a href="{{url('rating')}}" class="menu-item {{ ($segment1 == 'rating') ? 'active' : '' }}">{{
                            __('Rating')}}</a>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="submenu-content">
                        <a href="{{url('charts-chartist')}}"
                            class="menu-item {{ ($segment1 == 'charts-chartist') ? 'active' : '' }}">{{
                            __('Chartist')}}</a>
                        ...
                        <a href="{{url('charts-amcharts')}}"
                            class="menu-item {{ ($segment1 == 'charts-amcharts') ? 'active' : '' }}">{{
                            __('Amcharts')}}</a>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="submenu-content">
                        <a href="{{url('login-1')}}" class="menu-item {{ ($segment1 == 'login-1') ? 'active' : '' }}">{{
                            __('Login')}}</a>
                        <a href="{{url('register')}}"
                            class="menu-item {{ ($segment1 == 'register-1') ? 'active' : '' }}">{{ __('Register')}}</a>
                        <a href="{{url('forgot-password')}}"
                            class="menu-item {{ ($segment1 == 'forgot-password') ? 'active' : '' }}">{{ __('Forgot
                            Password')}}</a>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="submenu-content">
                        <a href="{{url('profile')}}" class="menu-item {{ ($segment1 == 'profile') ? 'active' : '' }}">{{
                            __('Profile')}}</a>
                        <a href="{{url('invoice')}}" class="menu-item {{ ($segment1 == 'invoice') ? 'active' : '' }}">{{
                            __('Invoice')}}</a>
                        <a href="{{url('project')}}" class="menu-item {{ ($segment1 == 'project') ? 'active' : '' }}">{{
                            __('Project')}}</a>
                        <a href="{{url('view')}}" class="menu-item {{ ($segment1 == 'view') ? 'active' : '' }}">{{
                            __('View')}}</a>
                        <a href="{{url('session-timeout')}}"
                            class="menu-item {{ ($segment1 == 'session-timeout') ? 'active' : '' }}">{{ __('Session
                            Timeout')}}</a>
                    </div>
                </div>
                ...
                <div class="nav-item">
                    <a href="javascript:void(0)" class="disabled"><i class="ik ik-slash"></i><span>{{ __('Disabled
                            Menu')}}</span></a>
                </div>
