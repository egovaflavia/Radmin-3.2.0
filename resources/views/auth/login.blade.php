                        ...
                        <div class="authentication-form mx-auto">
                            ...
                            @csrf
                                <div class="form-group">
                                    <input id="username" type="text" placeholder="username" class="form-control @error('username') is-invalid @enderror" name="username" value="admin@test.com" required autocomplete="username" autofocus>
